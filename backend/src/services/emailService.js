...
async function enviarConfirmacion(reserva) {
    ...
    // URL del botón de cancelación
    const cancelUrl = `${process.env.FRONTEND_URL || 'http://localhost:5173'}/api/reservas/cancelar/${cancelToken}`;
    const cancelUrlBackend = `http://localhost:3000/api/reservas/cancelar/${cancelToken}`;
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #faf9f7; padding: 40px; border-radius: 8px;">
          ...
          <p style="color: #888; font-size: 14px;">
            ⚠️ Si necesitas cancelar, hazlo con al menos <strong>48 horas de antelación</strong>.
          </p>
  
          <div style="text-align: center; margin: 32px 0;">
            <a href="${cancelUrlBackend}"
              style="
            ...
            <p style="color: #aaa; font-size: 12px; margin-top: 8px;">
              Este enlace dejará de funcionar 48h antes de tu cita.
            </p>
          </div>
